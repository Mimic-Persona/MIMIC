...
async function exploreUntil(
    ...
    return new Promise((resolve, reject) => {
        ...
        // Do the exploration in the given direction randomly. If callback is not null, the object is found
        const explore = () => {
            const x =
        ...
        // Set the new goal in explore every 2s
        explorationInterval = setInterval(explore, 2000);

        // Set timeout with the maxTime in second
