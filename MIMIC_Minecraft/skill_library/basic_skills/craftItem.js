const failedCraftFeedback = require("./craftHelper");
const {goals} = require('mineflayer-pathfinder');
const GoalLookAtBlock = goals.GoalLookAtBlock;

async function craftItem(bot, mcData, name, count = 1) {
    ...
    if (recipe) {
        ...
        failedCraftFeedback(bot, mcData, name, itemByName, craftingTable);
        // _craftItemFailCount++;
