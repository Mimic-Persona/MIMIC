...
async function preferenceAnalyze(socket, memoryRootPath, persona, memory, memoryID) {
    ...
    const persaContext = fs.readFileSync(`./src/main/java/com/codecool/dungeoncrawl/agent/context/personalities/${persona}.txt`, 'utf8');

    let context = fs.readFileSync("./src/main/java/com/codecool/dungeoncrawl/agent/context/preference_analyze_prompt.txt", 'utf8');
