...
//	public static final long DURATION = 60000 * 60 * 5; // Define the duration for running the monkey (in milliseconds)
	...
	public static boolean isInMonkeyMode;
	public static long startTime = -1;
	public static long prevTime = -1;

	public static boolean isInLLMMode;

	public static boolean isAgentNext;
	...
	public static void init() {
		...
		if (IS_IN_EXP && PRESET_SEED == -1) {
			seed = stack.pop();

		} else if (IS_IN_EXP) {
			// Discard the seeds in the stack until the preset seed is reached
			while (stack.peek() != PRESET_SEED) {
				stack.pop();
			}
			stack.pop();
			seed = stack.pop();
